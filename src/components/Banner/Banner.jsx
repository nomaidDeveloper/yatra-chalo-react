          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Join us to explore the world's wonders! From scenic mountains to vibrant cities, discover amazing places and cultures. Whether you seek adventure or relaxation, come create unforgettable memories with us.
                  <br />
                </p>
